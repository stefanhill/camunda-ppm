...
public class MergedClassifiersResource extends AbstractCockpitPluginResource {

	private String resourceName;
	public MergedClassifiersResource(String engineName, String resourceName) {
		super(engineName);
	  ...
	  public List<Pair<Classifier_Short_Description, Boolean>> getClassifier() throws Exception {
		  ...
		  return frh.get_classifier(false, true, null);
	  }
